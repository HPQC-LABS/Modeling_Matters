#!/bin/bash
#SBATCH --job-name=Opt_FeCO5.sh
#SBATCH --time=336:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=32
#SBATCH --mem=32G
#SBATCH --output=Opt_FeCO5.out
#SBATCH --error=Opt_FeCO5.err
...
cd $CFOURSCRATCH/
echo "Attempting to make Opt_FeCO520250305081035 in $CFOURSCRATCH/...  TIME: $(date +%Ec)"

mkdir Opt_FeCO520250305081035
if [ -e Opt_FeCO520250305081035/ ]; then
	echo "Success! TIME: $(date +%Ec)"
else
