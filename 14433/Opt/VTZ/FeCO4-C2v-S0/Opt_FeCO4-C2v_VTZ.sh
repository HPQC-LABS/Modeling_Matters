#!/bin/bash
#SBATCH --job-name=Opt_FeCO4-C2v_VTZ.sh
#SBATCH --time=336:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=32
#SBATCH --output=Opt_FeCO4-C2v_VTZ.out
#SBATCH --error=Opt_FeCO4-C2v_VTZ.err
...
CFOUROUTPUT=Opt_FeCO4-C2v_VTZ.out
...
cd $CFOURSCRATCH/
echo "Attempting to make Opt_FeCO4-C2v_VTZ20250901144010 in $CFOURSCRATCH/...  TIME: $(date +%Ec)"

mkdir Opt_FeCO4-C2v_VTZ20250901144010
if [ -e Opt_FeCO4-C2v_VTZ20250901144010/ ]; then
	echo "Success! TIME: $(date +%Ec)"
else
...
cd Opt_FeCO4-C2v_VTZ20250901144010
