#!/bin/bash
#SBATCH --job-name=Opt_FeCO5_VTZ.sh
#SBATCH --time=336:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=32
#SBATCH --output=Opt_FeCO5_VTZ.out
#SBATCH --error=Opt_FeCO5_VTZ.err
...
cd $CFOURSCRATCH/
echo "Attempting to make Opt_FeCO5_VTZ20250828233039 in $CFOURSCRATCH/...  TIME: $(date +%Ec)"

mkdir Opt_FeCO5_VTZ20250828233039
if [ -e Opt_FeCO5_VTZ20250828233039/ ]; then
	echo "Success! TIME: $(date +%Ec)"
else
...
cd Opt_FeCO5_VTZ20250828233039
