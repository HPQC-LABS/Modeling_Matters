...
cd $CFOURSCRATCH/
echo "Attempting to make FeCO4-C3v-S020250305081347 in $CFOURSCRATCH/...  TIME: $(date +%Ec)"

mkdir FeCO4-C3v-S020250305081347
if [ -e FeCO4-C3v-S020250305081347/ ]; then
	echo "Success! TIME: $(date +%Ec)"
else
...
cd ../
rm -rf FeCO4-C3v-S020250305081347
