#!/bin/bash
#SBATCH --job-name=Opt_FeCO5_aVDZ.sh
#SBATCH --time=336:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=32
#SBATCH --output=Opt_FeCO5_aVDZ.out
#SBATCH --error=Opt_FeCO5_aVDZ.err
...
CFOUROUTPUT=Opt_FeCO5_aVDZ.out
...
cd $CFOURSCRATCH/
echo "Attempting to make Opt_FeCO5_aVDZ20250828232806 in $CFOURSCRATCH/...  TIME: $(date +%Ec)"

mkdir Opt_FeCO5_aVDZ20250828232806
if [ -e Opt_FeCO5_aVDZ20250828232806/ ]; then
	echo "Success! TIME: $(date +%Ec)"
else
...
cd Opt_FeCO5_aVDZ20250828232806
