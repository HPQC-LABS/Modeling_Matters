#!/bin/bash
#SBATCH --job-name=Opt_FeCO4-C2v_aVDZ.sh
#SBATCH --time=336:00:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=32
#SBATCH --output=Opt_FeCO4-C2v_aVDZ.out
#SBATCH --error=Opt_FeCO4-C2v_aVDZ.err
...
CFOUROUTPUT=Opt_FeCO4-C2v_aVDZ.out
...
cd $CFOURSCRATCH/
echo "Attempting to make Opt_FeCO4-C2v_aVDZ20250829162307 in $CFOURSCRATCH/...  TIME: $(date +%Ec)"

mkdir Opt_FeCO4-C2v_aVDZ20250829162307
if [ -e Opt_FeCO4-C2v_aVDZ20250829162307/ ]; then
	echo "Success! TIME: $(date +%Ec)"
else
...
cd Opt_FeCO4-C2v_aVDZ20250829162307
