...
cd $CFOURSCRATCH/
echo "Attempting to make FeCO4-C2v-S020250822145918 in $CFOURSCRATCH/...  TIME: $(date +%Ec)"

mkdir FeCO4-C2v-S020250822145918
if [ -e FeCO4-C2v-S020250822145918/ ]; then
	echo "Success! TIME: $(date +%Ec)"
else
...
cp MOLDEN $JOBPATH/FeCO4-C2v-S0.molden
cp QUADRATURE $JOBPATH/FeCO4-C2v-S0.quadrature

echo "Attempting to clean $CFOURSCRATCH... save is False. TIME: $(date +%Ec)"
cd ../
rm -rf FeCO4-C2v-S020250822145918
